...
public class Religion implements Parcelable {
    ...
    public Religion(int id, String nameEN, String nameBN, String addressEN, String addressBN, String districtEN, String districtBN, String subDistrictEN, String subDistrictBN, String aboutEN, String aboutBN, int type, String typeEN, String typeBN, double latitude, double longitude, double distance, String photo) {
        this.id = id;
        this.nameEN = nameEN;
        this.nameBN = nameBN;
