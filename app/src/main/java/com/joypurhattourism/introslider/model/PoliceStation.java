...
public class PoliceStation implements Parcelable {
    public static final Creator<PoliceStation> CREATOR = new Creator<PoliceStation>() {
        public PoliceStation createFromParcel(Parcel in) {
            return new PoliceStation(in);
        }

        public PoliceStation[] newArray(int size) {
            return new PoliceStation[size];
        }
    };
    ...
    public PoliceStation(int id, String nameEN, String nameBN, String addressEN, String addressBN, String districtEN, String districtBN, String subDistrictEN, String subDistrictBN, String phoneEN, String phoneBN, double latitude, double longitude, double distance, String photo) {
        this.id = id;
        this.nameEN = nameEN;
        this.nameBN = nameBN;
    ...
    public PoliceStation(Parcel in) {
        this.id = in.readInt();
